    ...
    <title>Agendamento Sala Cliente</title>
     ...
     <nav class="navbar navbar-expand-lg" style="background-color: #ffffffdc;">
        ...
        <div class="text-center">
          <h1 style="color: rgba(245, 5, 65, 0.829);">Agendamento Sala 02</h1>
          </div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <form action="../conexao/salvar_data_02.php" method="post">
                    <!-- Inicio Projetor -->
                    <br>
                    <h5></h5>
...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
<script src="../atendimento-sala02/js/script.js"></script>
