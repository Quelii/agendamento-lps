...
<head>
    ...
    <title>Agendamento Sala Treinamento</title>
</head>
<!--Inicio nav bar-->
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="../treinamento/index.php"><h5>Treinamento</h5></a>
        </div>
      </div>
    </div>
  </nav>
...
<body>
 ...
 <div class="text-center">
          <h1 style="color: rgba(245, 5, 65, 0.829);">Treinamento</h1>
          </div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <form action="../conexao/salvar_data_03.php" method="post">
                    <!-- Inicio Projetor -->
                    <br>
                    <h5></h5>
...
<script src="../treinamento/js/script.js"></script>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
